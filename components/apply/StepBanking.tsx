  ...
  return (
    <div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2">
        <TextInput label="Bank Name" className="sm:col-span-2" required error={errors.bankName?.message} {...register("bankName")} />
        ...
        <TextInput label="Account Number" required error={errors.bankAccountNumber?.message} {...register("bankAccountNumber")} />
      </div>
    </div>
  );
}
